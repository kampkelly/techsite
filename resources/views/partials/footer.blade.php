        ...
        <div class="row">
            <div class="col-sm-8 col-xs-12" id="left" style="padding-right:0px;">
                ...
                <ul class="pull-right" id="right" style="display:inline;">
                    ...
                    <li><a href="all_posts.php"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                    <li><a href="all_posts.php"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                    <li><a href="all_posts.php"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                </ul>
            </div>
