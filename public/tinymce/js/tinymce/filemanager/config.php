...
//$root =env('APP_URL', 'production'); // don't touch this configuration
//$root = 'C:'; // don't touch this configuration
...
$base_url="http://newpqtech.dev"; //url base of site if you want only relative url leave empty
//$base_url=env('APP_URL', 'production'); //url base of site if you want only relative url leave empty
//$upload_dir = 'localhost'; // path from base_url to upload base dir
//$upload_dir = 'img/files'; // path from base_url to upload base dir
//$upload_dir = 'tinymce/images'; // path from base_url to upload base dir
$upload_dir = '/uploads'; // path from base_url to upload base dir
//$upload_dir = getenv('APP_ROOT_PATH').'/public/tinymce/source/'; // path from base_url to upload base dir
